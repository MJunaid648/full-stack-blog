...
const Write = () => {
  ...
  return (
    <div className="h-[calc(100vh-64px)] md:h-[calc(100vh-80px)] flex flex-col gap-6">
      ...
      <form className="flex flex-col flex-1 gap-6 mb-2">
        ...
        <textarea placeholder="A Short Description" className="p-4 rounded-xl bg-white shadow-md" />
        <ReactQuill theme="snow" className="flex-1 rounded-xl bg-white" />
        <button className="bg-blue-800 text-white font-medium rounded-xl mt-4 py-2 px-4 w-max ">Send</button>
      </form>
    </div>
  );
};
